                 ...
                 <caption>Customer: <strong>Mount Royal University</strong></caption>
                  ...
                  <tbody>
                    <?php
                        ...
                        outputOrderRow($file1, $title1, $quantity1, $price1,$amount1);
                        outputOrderRow($file2, $title2, $quantity2, $price2,$amount2);
                        outputOrderRow($file3, $title3, $quantity3, $price3,$amount3);
                        outputOrderRow($file4, $title4, $quantity4, $price4,$amount4);
                    ?>
