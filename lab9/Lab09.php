...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              for( $i=0;$i<count($countries);$i++){
                  $indexes=$index[$i];
                  echo   "<a href='list.php?country=Canada' role='button' class='btn btn-default'>   $countries[$indexes]</a> ";
              }
   ...
   //              </a>
          ...
          for( $i=0;$i<count($index2);$i++){
              ...
              echo "	<img src=\"images/square/".$temp["path"]."\" alt=";
              echo $temp["description"].">";
             echo "	<div class=\"caption\">
                		<div class=\"blur\">
                		</div>
                 		<div class=\"caption-text\"><h1>";
              echo $temp["title"];
              echo "</h1>
                		</div>
                 	</div>
